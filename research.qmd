...
## Publications
::: {.callout-abstractbox .callout-warning collapse=true}
## "Earnings Losses and the Role of the Welfare State during the COVID-19 Pandemic: Evidence from Sweden", *Review of Income and Wealth*, forthcoming (with Adrian Adermon, Lisa Laun, Patrik Lind, Martin Olsson, and Anna Sjögren)
...
::: {.callout-abstractbox .callout-warning collapse=true}
## "The Effect of Employment Protection on Firms' Worker Selection", *Journal of Human Resources*, forthcoming (with Sebastian Butschek)
...
::: {.callout-abstractbox .callout-warning collapse=true}
## "Firm Pay Dynamics", *Journal of Econometrics*, 233(3), pp. 396-423, 2023 (with Niklas Engbom and Christian Moser)
...
::: {.callout-abstractbox .callout-warning collapse=true}
## "Worker Reciprocity and the Returns to Training: Evidence from a Field Experiment", *Journal of Economics & Management Strategy*, 32(3), pp. 543-557, 2023
...
::: {.callout-abstractbox .callout-warning collapse=true}
## "Performance Measures and Workers' Productivity", *IZA World of Labor*, 260 (April), 2023
...
::: {.callout-abstractbox .callout-warning collapse=true}
## "Gender Bias in Teaching Evaluations", *Journal of the European Economic Association*, 17(2), pp. 535-566, 2019 (with Friederike Mengel and Ulf Zölitz)
...
::: {.callout-abstractbox .callout-warning collapse=true}
## "Working Hours and Productivity", *Labour Economics*, 47, pp. 96-106, 2017 (with Marion Collewet)
...
::: {.callout-abstractbox .callout-warning collapse=true}
## "Estimating the Relationship between Skill and Overconfidence", *Journal of Behavioral and Experimental Economics*, 68, pp. 18-24, 2017 (with Andries De Grip and Jan Feld)
...
::: {.callout-abstractbox .callout-warning collapse=true}
## "Referee Bias", *Journal of Economic Surveys*, 30(4), pp. 679-695, 2016 (with Thomas Dohmen)
...
::: {.callout-abstractbox .callout-warning collapse=true}
## "The Role of Peers in Estimating Tenure-Performance Profiles: Evidence from Personnel Data", *Journal of Economic Behavior & Organization*, 126, pp. 39-54, 2016 (with Andries De Grip and Inge Sieben)
...
::: {.callout-abstractbox .callout-warning collapse=true}
## "The Effect of Training on Productivity: The Transfer of On-the-job Training from the Perspective of Economics", *Educational Research Review*, 8, pp. 28-36, 2013 (with Andries De Grip)
...
::: {.callout-abstractbox .callout-warning collapse=true}
## "The Effects of Training on Own and Co-Worker Productivity: Evidence from a Field Experiment", *Economic Journal*, 122(560), pp. 376-399, 2012 (with Andries De Grip)
...
::: {.callout-abstractbox .callout-warning collapse=true}
## "What Makes a Good Conference? Analysing the Preferences of Labour Economists", *Labour Economics*, 17(5), pp. 868-874, 2010 (with Lex Borghans and Margo Romans)
...
::: {.callout-abstractbox .callout-warning collapse=true}
## "What Affects International Migration of Science and Engineering Graduates from Europe?", *Economics of Innovation and New Technology*, 19(5), pp. 407-421, 2010 (with Andries De Grip and Didier Fouarge)
...
::: {.callout-abstractbox .callout-warning collapse=true}
## "Does Temporary Employment Affect the Work-related Training of Low-skilled Employees?", *Journal for Labour Market Research*, 41(4), pp. 489-499, 2008 (with Eva Reinowski)
...
"Short- and Long-term Effects of Vocational versus General Schooling: A Regression Discontinuity Approach", April 2017 (with Anders Stenberg)
[most recent version: [download](https://jansauermann.github.io/papers/SauermannStenberg_VocationalGeneral.pdf)]

"Who Invests in Training if Contracts are Temporary? Empirical Evidence for Germany Using Selection Correction", IWH DP 14/06, July 2006
